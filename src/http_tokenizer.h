...
HT_LIB_API void http_tokenizer_consume_tokens(http_tokenizer* tokenizer, int count);

HT_LIB_API uint32_t http_tokenizer_execute(http_tokenizer* tokenizer, const char *data, uint32_t offset, uint32_t len);
